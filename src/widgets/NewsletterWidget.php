...
use dolphiq\newsletter\assetbundles\newsletterwidgetwidget\NewsletterWidgetWidgetAsset;
...
class NewsletterWidget extends Widget
{
    ...
    {
        return Craft::t('newsletter', 'NewsletterWidget');
    }
    ...
    {
        return Craft::getAlias("@dolphiq/newsletter/assetbundles/newsletterwidgetwidget/dist/img/NewsletterWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'newsletter/_components/widgets/NewsletterWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(NewsletterWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'newsletter/_components/widgets/NewsletterWidget_body',
            [
